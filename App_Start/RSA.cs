...
namespace Daimali.ISV
{
	...
	public sealed class RSAFromPkcs8
	{
       ...
       public static String addSignRSA(SortedDictionary<string, string> sParaTemp, String rsa_private)
        {
            string oid_partner;
        ...
        public static bool checkSignRSA(SortedDictionary<string, string> sParaTemp, String rsa_public)
        {
        ...
        static String genSignData(SortedDictionary<string, string> sParaTemp)
        {
